...
window.Template = (function( t, undefined ) {
	...
	/**
	* My wonderful class that does funky things.
	* @class WonderfulClass
	* @constructor
	* @chainable
	**/
	t.WonderfulClass = function() {
		var self = {};

		/**
		* My wonderful property. Stick to a code standard - under_score or camelCase!
		* @property wonderfulProperty
		* @type = {String}
		* @default "" 
		**/
		self.wonderfulProperty = "";

		/**
		* My wonderful private property. Closures! Your object has scope on this variable.
		* @property id
		* @type = {Number}
		* @default 0
		* @private
		...
		* @method init
		* @param {String} wonderful The initial value of our wonderful property
		* @param {Number} id Our value id!
		**/
		self.init = function(wonderful, id) {
